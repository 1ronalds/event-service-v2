...
INSERT INTO event (event_id, event_private_id, event_title, event_description, event_location_country, event_location_city, organiser_id, max_attendance, event_datetime, attendee_count, type)
